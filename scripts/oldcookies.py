...
# this approach still works but take around 25 seconds (could probably be less) to fetch cookies. I will still have the code around just in case. But the current approach (setcookies.py) take less than 10 seconds which is a signicant improvement. I ended up switch libraries to help bypess cloudflare
